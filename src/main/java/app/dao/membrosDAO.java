 ...
 * @generated
 */
@Repository("membrosDAO")
@Transactional(transactionManager="app-TransactionManager")
public interface membrosDAO extends JpaRepository<membros, java.lang.String> {

  /**
   * Obtém a instância de membros utilizando os identificadores
   * 
   * @param id
   *          Identificador 
   ...
   * @generated
   */    
  @Query("SELECT entity FROM membros entity WHERE entity.id = :id")
  public membros findOne(@Param(value="id") java.lang.String id);

  /**
   * Remove a instância de membros utilizando os identificadores
   * 
   * @param id
   *          Identificador 
   ...
   */    
  @Modifying
  @Query("DELETE FROM membros entity WHERE entity.id = :id")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.atende1.id = :id AND (:search = :search)")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.atende1.id = :id AND (:dataehora is null OR entity.dataehora = :dataehora)")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.atende2.id = :id AND (:search = :search)")
  public Page<Listaservicos> findListaservicos_2GeneralSearch(@Param(value="search") java.lang.String search, @Param(value="id") java.lang.String id, Pageable pageable);

  /** 
   * OneToMany Relation - Searchable fields - Specific search
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.atende2.id = :id AND (:dataehora is null OR entity.dataehora = :dataehora)")
  public Page<Listaservicos> findListaservicos_2SpecificSearch(@Param(value="id") java.lang.String id, @Param(value="dataehora") java.util.Date dataehora, Pageable pageable);
  ...
  public Page<Listaservicos> findListaservicos_2(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<membros> findmembrossByRegional(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<membros> findmembrossByMicroregional(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<membros> findmembrossByComum(@Param(value="id") java.lang.String id, Pageable pageable);
  ...
  public Page<membros> findmembrossByFuncao(@Param(value="id") java.lang.String id, Pageable pageable);
