...
public interface regionalDAO extends JpaRepository<regional, java.lang.String> {

  /**
   * Obtém a instância de regional utilizando os identificadores
   * 
   * @param id
   *          Identificador 
   ...
   * @generated
   */    
  @Query("SELECT entity FROM regional entity WHERE entity.id = :id")
  public regional findOne(@Param(value="id") java.lang.String id);

  /**
   * Remove a instância de regional utilizando os identificadores
   * 
   * @param id
   *          Identificador 
   ...
   */    
  @Modifying
  @Query("DELETE FROM regional entity WHERE entity.id = :id")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.regional.id = :id AND (:search = :search)")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Listaservicos entity WHERE entity.regional.id = :id AND (:dataehora is null OR entity.dataehora = :dataehora)")
   ...
   * @generated
   */
  @Query("SELECT entity FROM membros entity WHERE entity.regional.id = :id")
  ...
  public Page<microregional> findMicroregional_2(@Param(value="id") java.lang.String id, Pageable pageable);
  
  /**
   * ManyToOne Relation - Searchable fields - General search (Only strings fields)
   * @generated
   */
  @Query("SELECT entity.microregional FROM comum entity WHERE entity.regional.id = :id AND (entity.microregional.microregional_nome like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_sede like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregionao_cep like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_fonefixo like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_fonecel like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_logradouro like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_bairro like concat('%',coalesce(:search,''),'%') OR entity.microregional.microregional_email like concat('%',coalesce(:search,''),'%'))")
  public Page<microregional> listMicroregionalGeneralSearch(@Param(value="search") java.lang.String search, @Param(value="id") java.lang.String id, Pageable pageable);

  /**
   * ManyToOne Relation - Searchable fields - Specific search
   * @generated
   */
  @Query("SELECT entity.microregional FROM comum entity WHERE entity.regional.id = :id AND (:microregional_nome is null OR entity.microregional.microregional_nome like concat('%',:microregional_nome,'%')) AND (:microregional_sede is null OR entity.microregional.microregional_sede like concat('%',:microregional_sede,'%')) AND (:microregionao_cep is null OR entity.microregional.microregionao_cep like concat('%',:microregionao_cep,'%')) AND (:microregional_fonefixo is null OR entity.microregional.microregional_fonefixo like concat('%',:microregional_fonefixo,'%')) AND (:microregional_fonecel is null OR entity.microregional.microregional_fonecel like concat('%',:microregional_fonecel,'%')) AND (:microregional_logradouro is null OR entity.microregional.microregional_logradouro like concat('%',:microregional_logradouro,'%')) AND (:microregional_bairro is null OR entity.microregional.microregional_bairro like concat('%',:microregional_bairro,'%')) AND (:microregional_email is null OR entity.microregional.microregional_email like concat('%',:microregional_email,'%'))")
  public Page<microregional> listMicroregionalSpecificSearch(@Param(value="id") java.lang.String id, @Param(value="microregional_nome") java.lang.String microregional_nome, @Param(value="microregional_sede") java.lang.String microregional_sede, @Param(value="microregionao_cep") java.lang.String microregionao_cep, @Param(value="microregional_fonefixo") java.lang.String microregional_fonefixo, @Param(value="microregional_fonecel") java.lang.String microregional_fonecel, @Param(value="microregional_logradouro") java.lang.String microregional_logradouro, @Param(value="microregional_bairro") java.lang.String microregional_bairro, @Param(value="microregional_email") java.lang.String microregional_email, Pageable pageable);

  /**
   * ManyToOne Relation
   * @generated
   */
  @Query("SELECT entity.microregional FROM comum entity WHERE entity.regional.id = :id")
  public Page<microregional> listMicroregional(@Param(value="id") java.lang.String id, Pageable pageable);
   ...
   */
  @Modifying
  @Query("DELETE FROM comum entity WHERE entity.regional.id = :instanceId AND entity.microregional.id = :relationId")
  public int deleteMicroregional(@Param(value="instanceId") java.lang.String instanceId, @Param(value="relationId") java.lang.String relationId);
   ...
   * @generated
   */
  @Query("SELECT entity FROM regional entity WHERE entity.regional_nome like concat('%',coalesce(:search,''),'%') OR entity.regional_sede like concat('%',coalesce(:search,''),'%') OR entity.regional_cep like concat('%',coalesce(:search,''),'%') OR entity.regional_fonefixo like concat('%',coalesce(:search,''),'%') OR entity.regional_fonecel like concat('%',coalesce(:search,''),'%') OR entity.regional_logradouro like concat('%',coalesce(:search,''),'%') OR entity.regional_bairro like concat('%',coalesce(:search,''),'%') OR entity.regional_email like concat('%',coalesce(:search,''),'%')")
  public Page<regional> generalSearch(@Param(value="search") java.lang.String search, Pageable pageable);

  /**
   * Searchable fields - Specific search
   * @generated
   */
  @Query("SELECT entity FROM regional entity WHERE (:regional_nome is null OR entity.regional_nome like concat('%',:regional_nome,'%')) AND (:regional_sede is null OR entity.regional_sede like concat('%',:regional_sede,'%')) AND (:regional_cep is null OR entity.regional_cep like concat('%',:regional_cep,'%')) AND (:regional_fonefixo is null OR entity.regional_fonefixo like concat('%',:regional_fonefixo,'%')) AND (:regional_fonecel is null OR entity.regional_fonecel like concat('%',:regional_fonecel,'%')) AND (:regional_logradouro is null OR entity.regional_logradouro like concat('%',:regional_logradouro,'%')) AND (:regional_bairro is null OR entity.regional_bairro like concat('%',:regional_bairro,'%')) AND (:regional_email is null OR entity.regional_email like concat('%',:regional_email,'%'))")
  public Page<regional> specificSearch(@Param(value="regional_nome") java.lang.String regional_nome, @Param(value="regional_sede") java.lang.String regional_sede, @Param(value="regional_cep") java.lang.String regional_cep, @Param(value="regional_fonefixo") java.lang.String regional_fonefixo, @Param(value="regional_fonecel") java.lang.String regional_fonecel, @Param(value="regional_logradouro") java.lang.String regional_logradouro, @Param(value="regional_bairro") java.lang.String regional_bairro, @Param(value="regional_email") java.lang.String regional_email, Pageable pageable);
